(function () {
  ...
  var expando = (jQuery.expando = "jQuery" + now()),
    uuid = 0,
    windowData = {};
  jQuery.extend({
    cache: {},
  ...
  if (document.documentElement["getBoundingClientRect"])
    ...
    jQuery.fn.offset = function () {
      ...
      while (
        ...
        if (
          (!isAbsolute && prevComputedStyle.position === "static") ||
  ...
  (function () {
    ...
    var getCompatMode = function () {
      ...
      if (!compatMode && jQuery.browser.safari) {
        if (!safariCompatMode) {
          var width = jQuery(document.createElement("div"))
            .attr("style", "position:absolute;width:0;height:0;width:1")
            .css("width");
          safariCompatMode = compatMode =
            width == "1px" ? "BackCompat" : "CSS1Compat";
        } else {
...
if (!window.RichFaces.Memory) {
  ...
  window.RichFaces.Memory.addComponentCleaner(
    "richfaces",
